...
public class StudentCommandHandler {
    ...
    public void processCommand(Command command){
        ...
        try {
            switch (action){
                case CREATE -> {
                    processedCreateCommand(command);
                    break;
                }
                case UPDATE -> {
            ...
            System.out.println("Введенные данные не могут быть интерпретированы " + ex.getMessage());
    ...
    private void processedCreateCommand(Command command){
